...
@Component({
  selector: 'app-example',
  standalone: true,
  imports: [BlocDatePickerTriggerDirective, FormsModule],
  templateUrl: './example.component.html',
})
export class ExampleComponent {
...
@Component({
  selector: 'app-example',
  standalone: true,
  imports: [BlocDatePickerTriggerDirective, ReactiveFormsModule],
  templateUrl: './example.component.html',
})
export class ExampleComponent {
...
export class ExampleComponent {
  disabledCtrl = new FormControl<Date | null>(new Date());
