...
@Component({
  ...
  styles: `
    ...
    .code-wrapper.is-open { grid-template-rows: 1fr; }
    ...
    .copy-btn:hover { background: rgba(255,255,255,1); color: #1e293b; }
    ...
    <div class="code-wrapper" [class.is-open]="open()" #wrapper>
      <div class="code-inner">
        <div class="code-container" #codeBlock>
          <button class="copy-btn" [class.copied]="copied()" (click)="copyCode()" type="button" title="Copy code">
            @if (copied()) {
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
